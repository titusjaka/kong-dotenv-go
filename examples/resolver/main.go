...
type CLI struct {
	EnvFile kong.ConfigFlag `kong:"optional,default='.env',name=env-file,help='Path to .env file'"`
...
func (c CLI) Run() error {
	...
	// Output: Env File: .env; Env Var String: ENVFileReader; Env Var Int: 132.
...
func main() {
	...
	kCtx := kong.Parse(&cli, kong.Configuration(kongdotenv.ENVFileReader))
